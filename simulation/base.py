...
def simulate_with_(algorithm, config=None, circles=200, dump=True, algorithm_type='original', **kwargs):
    """
    ...
    if algorithm_type == 'optimal':
        ...
        algorithm_rewards = agent.comparison_(algorithm, circles=circles, dump=dump)
